...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Review For Company') }}</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('companyReviews') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="rating" class="col-md-4 col-form-label text-md-right">{{ __('choose your rating for your guide') }}</label>
