                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('addCompany') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="about" class="col-md-4 col-form-label text-md-right">{{ __('About As') }}</label>

                                <div class="col-md-6">
                                    <input id="about" type="text" class="form-control @error('aboutus') is-invalid @enderror" name="aboutus">
